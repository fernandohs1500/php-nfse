 ...
 * Uberlandia - MG
 * conforme o modelo Abrasf 2.04 Modificado.
 *
 * @category  NFePHP
...
class Tools extends ToolsAbrasf
{
     ...
     */
    protected $url = [
        1 => 'https://nfsews.uberlandia.mg.gov.br:8003/nfse-ws/soap/nfse.wsdl',
        2 => 'https://nfsews-hml.uberlandia.mg.gov.br:8003/nfse-ws/soap/nfse.wsdl'
    ];
    /**
     * County Namespace
     * @var string
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3170206\\v{$this->versao}\\RecepcionarLoteRps";
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3170206\\v{$this->versao}\\ConsultarLoteRps";
        $fact = new $class($this->certificate);
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3170206\\v{$this->versao}\\CancelarNfse";
        $fact = new $class($this->certificate);
